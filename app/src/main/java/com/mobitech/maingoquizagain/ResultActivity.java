...
public class ResultActivity extends AppCompatActivity {
    ...
    Button btStartQuiz,btnSendEmail;
    Button btMainMenu,btnView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSendEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String result = txtCorrectQues.getText().toString();
                String subject = "AptiHub Exam Result";
                String message = "Your Total Score is:  " +result;
                Intent email = new Intent(Intent.ACTION_SEND);
                email.putExtra(Intent.EXTRA_EMAIL, new String[]{ AppData.email});
        ...
        btnView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), ViewAllQues.class));
            }
        });
